...
public class Doubles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        treble = findViewById(R.id.editDouble);
        ...
        b0.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                displayScore();
                if(t >20){
                    Toast.makeText(Doubles.this, "Your Score Was "+disS, Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Doubles.this, Home.class);
