...
public class ThreeZeroOne extends AppCompatActivity {
        ...
        enter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (game == 0) {
                    ...
                    if (length > 180) {
                        Toast.makeText(ThreeZeroOne.this, "Can't Score More Than 180", Toast.LENGTH_SHORT).show();
                        clear();
                        displayCurrent();
                        if (length > p1CS) {
                        ...
                        if (length > p1CS) {
                            ...
                            if (p1CS==1){
                                ...
                                Toast.makeText(ThreeZeroOne.this, "Player 1 Wins", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(ThreeZeroOne.this, Home.class);
                    ...
                    if (length > 180) {
                        ...
                        if (length > p2CS) {
                            ...
                            if (p2CS > 0) {
                                ...
                                Toast.makeText(ThreeZeroOne.this, "Player 2 Wins", Toast.LENGTH_SHORT).show();
                                Intent intent = new Intent(ThreeZeroOne.this, Home.class);
                                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                                startActivity(intent);
                            }
